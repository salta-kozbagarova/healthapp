      ...
      <main>
        <section class="camera_container">
          <div id="camera" class="camera_wrap">
            <div data-src="${contextPath}/resources/images/page-1_slide01.jpg">
            ...
            <div data-src="${contextPath}/resources/images/page-1_slide02.jpg">
              <div class="camera_caption fadeIn">
                <div class="container">
                  <div class="row">
            ...
            <div data-src="${contextPath}/resources/images/page-1_slide03.jpg">
              <div class="camera_caption fadeIn">
                <div class="container">
                  <div class="row">
        ...
        <section class="well1">
          <div class="container">
            <div class="row">
              <div class="grid_4">
                <h2>About</h2><img src="${contextPath}/resources/images/page-1_img01.jpg" alt="">
                ...
                <div class="owl-carousel">
                  <div class="item">
                    <blockquote class="box">
                      <div class="box_aside"><img src="${contextPath}/resources/images/page-1_img02.jpg" alt=""></div>
                      <div class="box_cnt__no-flow">
                        <p>
                  ...
                  <div class="item">
                    <blockquote class="box">
                      <div class="box_aside"><img src="${contextPath}/resources/images/page-1_img03.jpg" alt=""></div>
                      <div class="box_cnt__no-flow">
                        <p>
                          <q>Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</q>
                        </p>
                  ...
                  <div class="item">
                    <blockquote class="box">
                      <div class="box_aside"><img src="${contextPath}/resources/images/page-1_img04.jpg" alt=""></div>
                      <div class="box_cnt__no-flow">
                        <p>
                          <q>Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</q>
                        </p>
                  ...
                  <div class="item">
                    <blockquote class="box">
                      <div class="box_aside"><img src="${contextPath}/resources/images/page-1_img05.jpg" alt=""></div>
                      <div class="box_cnt__no-flow">
                        <p>
                          <q>Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</q>
                        </p>
